...
const ShareModal = (props) => {
    ...
    return (
        <>
            <div onClick={() => { openMenu() }} className="w-full flex justify-end">
                <button className="px-4 py-2 text-sm rounded-full border bg-yellow-600 shadow-lg" >Share</button>
            </div>
            <div id="shareModal" onClick={(e) => e.target.id === "shareModal" && closeMenu()} ref={shareRef} className="fixed top-0 overflow-hidden h-0 bottom-0 left-0 right-0 transition duration-500 opacity-0 bg-gray-900/50 grid place-items-end p-3">
                <div className="mx-auto w-full max-w-3xl p-4 grid rounded-xl bg-slate-200 text-black gap-2 ">
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        {/* <a href="https://wa.me/?text=Hello%20from%20my%20site!" target="_blank" className="grid w-16  ">
                            <Image width={100} height={100} className="rounded-xl aspect-square object-cover" src="/profile_pic.png" alt="" />
