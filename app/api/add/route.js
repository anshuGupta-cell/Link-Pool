...
export const POST = async (req) => {
    ...
    try {
        const res = await pool.query(`insert into handle(handle_name, uid, description, pfp_url, type) values($1, $2, $3, $4, $5) RETURNING hno`, [body.handle, user.id, body.desc, body.pic, body.type])
